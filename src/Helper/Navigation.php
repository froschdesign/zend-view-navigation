...
use Zend\View\Navigation\Helper\AbstractHelper as AbstractNavigationHelper;
use Zend\View\Navigation\Helper\HelperInterface as NavigationHelperInterface;
...
class Navigation extends AbstractNavigationHelper
{
     ...
     *
     * @param  NavigationHelperInterface $helper helper instance
     * @return void
     */
    protected function inject(NavigationHelperInterface $helper)
    {
    ...
    public function getPluginManager()
    {
        if (null === $this->plugins) {
            $this->setPluginManager(new PluginManager($this->getServiceLocator()));
        }
